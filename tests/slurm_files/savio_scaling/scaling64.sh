...
#SBATCH --output=/global/home/users/esromabraham/jax_rmhd/tests/scaling64_YAML_test.out
#SBATCH --error=/global/home/users/esromabraham/jax_rmhd/tests/scaling64_YAML_test.err
#SBATCH --mem=0
